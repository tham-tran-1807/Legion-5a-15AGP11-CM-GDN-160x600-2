...
lib.ssMetadata = [
		{name:"Legion_5a_15AGP11_CM_GDN_160x600_atlas_1", frames: [[1134,0,50,50],[0,0,160,600],[162,0,160,600],[324,0,160,600],[486,0,160,600],[648,0,160,600],[810,0,160,600],[972,0,160,600]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["Legion_5a_15AGP11_CM_GDN_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.Legion5a15AGP11CMGDN160x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(373).call(this.frame_373).wait(37));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_replay).wait(372).to({_off:false},0).wait(38));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(179).to({_off:false},0).to({_off:true},61).wait(170));

	// Layer_3
	this.instance_4 = new lib.Frame3();
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(120).to({_off:false},0).to({_off:true},59).wait(231));

	// Layer_2
	this.instance_5 = new lib.Frame2();
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(59).to({_off:false},0).to({_off:true},61).wait(290));

	// Layer_1
	this.instance_6 = new lib.Frame1();

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true},59).wait(351));
...
// library properties:
lib.properties = {
	id: '41D0A6469A26DF47A3C6770A100FC837',
	width: 160,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Legion_5a_15AGP11_CM_GDN_160x600_atlas_1.png", id:"Legion_5a_15AGP11_CM_GDN_160x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['41D0A6469A26DF47A3C6770A100FC837'] = {
